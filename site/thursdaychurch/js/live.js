...
$(document).ready(function () {
    ...
    function onFinish() {
        if (outroVideoPlaying == false) {
            $('#video-holder').html('<iframe id="ls_embed_1458644761" src="https://livestream.com/accounts/6957/events/1000825/player?width=960&height=540&enableInfoAndActivity=false&autoPlay=true&mute=false" width="960" height="540" frameborder="0" scrolling="no"></iframe><script type="text/javascript" data-embed_id="ls_embed_1458644761" src="//livestream.com/assets/plugins/referrer_tracking.js"></script>');
            $("body").fitVids({
