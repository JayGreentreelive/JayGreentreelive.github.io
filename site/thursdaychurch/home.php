    ...
    <div class="row">
          <div class="col-md-6 order-md-1">
            ...
            <div class="block-15">
              ...
              <div class="text mb-5">
              <p class="mb-4">We welcome the opportunity to connect with you and your family. We have lots of opportunities to get connected and meet new people. Feel free to browse through our web site and learn about the exciting things happening at Thursday Church</p>
              <p class="mb-4">We meet on Thursdays at 6:45 pm at our Vincennes and Bicknell campuses. We offer a Sunday morning service at 10:45 am at our Vincennes Campus. We provide programs for children 5th grade and under during services on Thursdays at both campuses and on Sundays at the Vincennes Campus.</p>
...
<div class='section section-locations' >
  <div class='container pd-t-lg pd-b-lg'>
    ...
    <?php
    $lp_times = 'Sundays: 12:30 pm';
    $cp_times = 'Thursdays: 6:45 pm';
    $ck_times = 'Thursdays: 6:45 pm <br />Sundays: 10:45am';
    $home_service_times = 'Times';
    ?>
    <div class="row">
    ...
    <div class='row'>
            ...
            <div class='pd-xs'>
              <a href='#'><img src='/site/assets/files/1/map1.png' class='img-responsive img-full-width'/></a>
             ...
             <p class='campus-times'><?php echo $ck_times;?></p>
               ...
               <div class=' mg-t-sm2'><a href='/locations/vincennes' class='btn btn-default btn-left '><i class='icon-right-4 icon-fw'></i> Campus Info</a></div>
            </div>
         ...
         <div class="col-xs-12 col-sm-4 col-md-4">
             <div class='pd-xs'>
            <a href='#'><img src='/site/assets/files/1/map2.png'   class='img-responsive img-full-width'/></a>
           ...
           <ul class="fa-ul">
                <li>
                  <i class="fa-li icon-location-pin-1"></i>
                  114 South Main St<br/>
            Bicknell, IN, 47512</li>
              <li><i class="fa-li icon-call-2"></i>812.502.2124</li>
            </ul>
            <div class='mg-t-sm2'><a href='/locations/bicknell' class='btn btn-default btn-left  '><i class='icon-right-4 icon-fw'></i> Campus Info</a></div>
            </div>
        </div>

         <div class="col-xs-12 col-sm-4 col-md-4">
           <div class='pd-xs'>
            <a href='#'><img src='/site/assets/files/1/map3.png'  class='img-responsive img-full-width'/></a>
