...
<div class='section ' style='background-color:#efefef;'>
        ...
        <div class="container pd-t-md pd-b-lg ">
            <div class="row multi-columns-row ">
                ...
                <?php
                    $Groups =  $pages->find("parent=/lifegroups/,  sort=-date, template=lifegroup, limit=12");


                    $pagination =  $Groups->renderPager(array(
                    'nextItemLabel' => "&raquo;",
                    'numPageLinks' => 5,
     ...
     <?php
                      ...
                      <?php
                        ...
                        if(!$data = $cache->get("group_topics", 29990)) {
                            ...
                            {
                                $blog_count = $pages->count("parent=/lifegroups/,  category=$category, template=group-details");
                                if( $group_count  > 0 ){
