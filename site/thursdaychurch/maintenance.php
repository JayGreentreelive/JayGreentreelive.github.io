...
<html lang='en'>
  ...
  <head>
    ...
    <title>Website offline for maintenance</title>
   ...
   <link rel="stylesheet" href="/site/assets/aiom/css_ac70e2156d483fa7069ed5d2e3cd165b.css">
...
<div id='wrapper' class='page-id-27 template-basic-page  '>

<div class='header   ' id='chapel-header-bar'>
    <div id='search-area'>
       <div class='container'>
                <div class='row'>
                    <div class='col-md-8 col-md-offset-2'>
                          <div class="searchTop">
                             ...
                             <form id="search-form-top" class='clearfix' action='/search/' method='get'>
                                    <input class="clear-click" id='search-site-input' placeholder='Search the site' type='text' name='q' value=''>
  ...
  <div id='floating-bar-nav' >
       ...
       <div id='top-quick-menu' class=''>
        ...
        <div id='nav-main-menu' class='nav-content-holder ' >
                    ...
                    <div class='col-md-12'>
                            ...
                            <ul id="nav-pullout">
                                <li id="nav_about" class='dropdown'><a href='#' id='about-nav' >About</a>
                                  <ul >
                                    <li ><a href='/about/'>About <span class="icon-right-circle-12"></span></a></li>
                                    ...
                                    <li ><a href='/about/contact'>Contact <span class="icon-right-circle-12"></span></a></li>
                                  </ul>
                                </li>
                                <li id="nav_locations" class='dropdown'><a href='#' >Locations</a>
                                  <ul>

                                    <li><a href='/locations/vincennes'>Vincennes <span class="icon-right-circle-12"></span></a></li>
                                    <li><a href='/locations/bicknell'>Bicknell <span class="icon-right-circle-12"></span></a></li>
                                    <li><a href='/locations/french-creole'>French (Creole) <span class="icon-right-circle-12"></span></a></li>
                                  </ul>
                                </li>
                                <li id="nav_connect" class='dropdown'><a href='#'>Ministries</a>
                                 <ul>
                                  <li><a href="/ministries/kids/">Kids Ministry <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="/ministries/students/">Youth Ministry <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="/ministries/life-groups/">LIFE Groups <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="/ministries/global-missions/">Global Missions <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="/ministries/celebrate-recovery/">Celebrate Recovery <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="/ministries/mobile-food-pantry/">Mobile Food Pantry <span class="icon-right-circle-12"></span></a></li>
                                  <li><a href="javascript:void(0);">TC Businesses <span class="icon-right-circle-12"></span></a></li>
                                </ul>
                                </li>
                                ...
                                <li id="nav_outreach" class='dropdown'><a href='#' >Online Giving</a>
                                   <ul>
                                ...
                                <li id="nav_resources" class='dropdown'><a href='#' >Watch</a>
                                  <ul>
                                     ...
                                     <li><a href='/live/'>Live <span class="icon-right-circle-12"></span></a></li>
  ...
  <div id='top-area' class='top-home  top-short-header  ' >
...
<p>Page not found. Please use the menu or search the website.</p>
            ...
            <div class='container'>
                <div class='row'>
                  <div class='col-xs-6 col-md-10 col-sm-9' >
                          ...
                          <div class='item'><a class="mg-l-xs  inline-popup-link" href="#share-story-popup">Share Your Story</a></div>
                          <div class='item'><a href="#">812.882.2737</a></div>
                          <div class='item'><a class="mg-l-xs  inline-popup-link" href="#contact-form-popup">Email Us</a></div>
                  </div>
   ...
   <!-- Javascript ================================================== -->
    ...
    <script>window.jQuery || document.write('<script src="/js/plugins/jquery/jquery.min.js" type="text/javascript"><\/script>')</script>
    <script src="/js/js-footer-min-gzip.js"></script>
<script>
    (function() {
        var j = false;
...
$(document).ready(function() {
    ...
    function onFinish() {
        if (outroVideoPlaying == false) {
            $('#video-holder').html('<iframe id="ls_embed_1458644761" src="width="560" height="315" src="https://www.youtube.com/embed/" frameborder="0" allowfullscreen"></iframe>');
            $("body").fitVids({
        ...
        function(e) {
            ...
            if (str.indexOf("bible") > -1) {
                if ($('#bible-tab').find("iframe").length == 0) {
                    $('#bible-tab').append('<iframe frameborder="0" allowtransparency="true" src="https://www.bible.com/bible/111/matthew.1.nlt" class="bible-iframe" style="padding:0px;margin:0px;width:100%;min-height: 645px;max-height: 700px;height: 100%;"></iframe>');
                }
            }
        })
        ...
        function(e) {
            ...
            if (str.indexOf("chat") > -1) {
                if ($('#welcome-tab').find("iframe").length == 0) {
                    $('#welcome-tab').append('<iframe frameborder="0" allowtransparency="true" src="https://www.youtube.com/live_chat?v=&embed_domain=" class="chat-iframe" style="padding:0px;margin:0px;width:100%;min-height: 645px;max-height: 700px;height: 100%;"></iframe>');
                }
            }
        })
