...
<div role="tabpanel" class='page-section-tabs <?php echo $cclass;?>'>
  ...
  <ul class="nav nav-tabs nav-justified " role="tablist">
    ...
    foreach ($content as $c) {
        ...
        $tabName =  $sanitizer->pageName($c->title);
        echo " <li  class='{$active} '><a href='#{$tabName}-tab' aria-controls='{$tabName}-tab' role='tab' data-toggle='tab'><div class='text-center'><span>{$c->title}</span></div></a></li>";
        $xx++;
    }
    ?>
  </ul>
