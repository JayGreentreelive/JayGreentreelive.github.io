...
/**
 * Output a single group post
 *
 * Used by /site/templates/markup/groups.php (via include)
 *
 * VARIABLES:
 * ==========
 * $page - the group post to render (Page)
...
<div class='post serif' id='post-<?php echo $page->id; ?>'>
    ...
    <div class='post-head'>
        ...
        echo "<p class='post-author text-muted' style='display:none;'>By <a href='/group/author/{$authorURL}'>{$page->createdUser->title}</a>";
