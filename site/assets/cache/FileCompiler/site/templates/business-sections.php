<?php
 ...
 include(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . "site/templates/includes/head.inc",array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
    ...
    $sections = $pages->find('parent='.$page->id.',template=business-section, sort=sort');
...
<div class="col-md-12 col-lg-5 page-section business-sidebar" id="section-sidebar"-->


       <?php if( count($page->tabbed_content) > 0 ){
                        print "<h1 style='margin-bottom:30px;'>{$section->title}</h1>";
                        $t = new \ProcessWire\TemplateFile(\ProcessWire\wire('files')->compile($config->paths->templates .'markup/business/tabbed_content.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
        ...
        <div class="container  mg-t-lg">
            <div class="row ">
                ...
                <div class='<?php echo $section->no_sidebar == 1 ? " col-md-12 " : " col-md-8 ";?> '>
                 ...
                 <!--div class='col-md-3 col-md-offset-1 sidebar-section' -->
                 <div class="col-md-12 col-lg-5 page-section business-sidebar section-sidebar">
