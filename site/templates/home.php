...
<h2>Welcome</h2>
<p>We welcome the opportunity to connect with you and your family. We have lots of opportunities 
to get connected and meet new people. Feel free to browse through our web site and learn about the exciting things happening at Thursday Church.</p>

<p>We meet on Thursdays at 6:45 pm at our Vincennes and Bicknell campuses. We offer a Sunday morning service at 10:45 am at our Vincennes Campus. We provide programs for children 5th grade and under during services on Thursdays at both campuses and on Sundays at the Vincennes Campus.
</p>
    ...
    <div class='row'>
            ...
            <div class='pd-xs'>
             ...
             <p class='campus-times'><?php echo $tcv_times;?></p>
               ...
               <ul class="fa-ul">
                <li><a href='http://thursday.church/tcvdirections' target="_blank"><i class="fa-li icon-location-pin-1"></i>
                                 218 Main St<br/>
         ...
         <div class="col-xs-12 col-sm-4 col-md-4">
           ...
           <ul class="fa-ul">
                ...
                <li><a href='' target="_blank"><i class="fa-li icon-location-pin-1"></i>114 South Main St<br/>
            Bicknell, IN, 47512</a></li>
              <li><i class="fa-li icon-call-2"></i>812.502.2124</li>
            </ul>
            <div class='mg-t-sm2'><a href='http://thursday.church/tcbdirections' class='btn btn-default btn-left'><i class='icon-right-4 icon-fw'></i> Get Directions</a></div>
            </div>
        </div>
         ...
         <div class="col-xs-12 col-sm-4 col-md-4">
           ...
           <p class='campus-times'><?php echo $tcf_times;?></p>
             ...
             <ul class="fa-ul">
               <li><i class="fa-li icon-location-pin-1"></i>218 Main St<br/>
            Vincennes, IN 47591</li>
              <li><i class="fa-li icon-call-2"></i> </li>
            </ul>
             <div class=' mg-t-sm2'><a href='http://thursday.church/tcfdirections' class='btn btn-default btn-left'><i class='icon-right-4 icon-fw'></i> Get Directions</a></div>
            </div>
        </div>
    </div>
  </div>
...
<div class='section section-gray' style="display:none;">
    ...
    <div class="row">
      ...
      <?php
            if(!$data = $cache->get("home_blog", 86400)) {
                $featured_posts = $pages->find("parent=/ministries/life-groups/, template=lifegroups, home_featured=1, limit=3, sort=-date");
                 foreach ( $featured_posts as $block)
                 {
                    $data .= '<div class="col-xs-12 col-sm-4 col-md-4"> <div class="home-content-block">';

                    $thumb = $pages->get('/ministries/life-groups/')->images->first()->size(640,293)->url;
