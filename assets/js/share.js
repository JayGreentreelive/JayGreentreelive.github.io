...
;(function ( $, window, document, undefined ) {
  ...
  defaults = {
    ...
    text: document.title,
    urlCurl: '/tools/google-share/',  //PHP script for google plus...
  ...
  loadButton = {
    googlePlus : function(self){
      ...
      if(typeof gapi === 'undefined' && loading == 0){
        ...
        (function() {
          ...
          po.src = '//web.archive.org/web/20190703103330/https://apis.google.com/js/plusone.js';
    ...
    facebook : function(self){
      ...
      if(typeof FB === 'undefined' && loading == 0){
        ...
        (function(d, s, id) {
          ...
          js.src = '//web.archive.org/web/20190703103330/https://connect.facebook.net/'+sett.lang+'/all.js#xfbml=1';
    ...
    twitter : function(self){
      ...
      if(typeof twttr === 'undefined' && loading == 0){
        ...
        (function() {
          ...
          twitterScriptTag.src = '//web.archive.org/web/20190703103330/https://platform.twitter.com/widgets.js';
          var s = document.getElementsByTagName('script')[0];
          s.parentNode.insertBefore(twitterScriptTag, s);
        })();
      }
      else{
        $.ajax({ url: '//web.archive.org/web/20190703103330/https://platform.twitter.com/widgets.js', dataType: 'script', cache:true}); //https://stackoverflow.com/q/6536108
      }
    },
    digg : function(self){
      ...
      if(typeof __DBW === 'undefined' && loading == 0){
        ...
        (function() {
          ...
          s.async = true;
          s.src = '//web.archive.org/web/20190703103330/https://widgets.digg.com/buttons.js';
    ...
    stumbleupon : function(self){
      ...
      if(typeof STMBLPN === 'undefined' && loading == 0){
        ...
        (function() {
          ...
          li.src = '//web.archive.org/web/20190703103330/https://platform.stumbleupon.com/1/widgets.js';
    ...
    linkedin : function(self){
      ...
      if(typeof window.IN === 'undefined' && loading == 0){
        ...
        (function() {
          var li = document.createElement('script');li.type = 'text/javascript';li.async = true;
          li.src = '//web.archive.org/web/20190703103330/https://platform.linkedin.com/in.js';
          var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(li, s);
        })();
      }
      else{
    ...
    pinterest : function(self){
      ...
      (function() {
        var li = document.createElement('script');li.type = 'text/javascript';li.async = true;
        li.src = '//web.archive.org/web/20190703103330/https://assets.pinterest.com/js/pinit.js';
        var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(li, s);
      })();
    }
  },
  ...
  Plugin.prototype.getSocialJson = function (name) {
    ...
    if(url != '' && self.options.urlCurl !== '' && name != 'twitter'){  //urlCurl = '' if you don't want to used PHP script but used social button
  ...
  Plugin.prototype.renderer = function () {
    ...
    if(template !== ''){  //if there is a template
      ...
      $(this.element).html(
                            '<div class="box"><a class="count ' + moreThanZero + '" href="#">' + total + '</a>' +
...
/*
     FILE ARCHIVED ON 10:33:30 Jul 03, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:22:46 Oct 05, 2019.
...
/*
playback timings (ms):
  captures_list: 546.875
  RedisCDXSource: 66.721
  exclusion.robots.policy: 0.144
  esindex: 0.012
  exclusion.robots: 0.153
  PetaboxLoader3.resolve: 71.317
  LoadShardBlock: 466.82 (3)
  CDXLines.iter: 10.234 (3)
  PetaboxLoader3.datanode: 621.819 (4)
  load_resource: 228.553
*/